      ...
      <div className='flex w-full mt-[4rem]'>
        ...
        {isSlideBarOpen ?
          ...
          <button
            ...
            className='lg:hidden bg-black h-[2.3rem] w-[3rem] rounded-tr-lg rounded-br-lg  flex items-center justify-end p-2 fixed z-20 '><FaAnglesRight className='text-[1.5rem] text-white' />
          </button>
        }
