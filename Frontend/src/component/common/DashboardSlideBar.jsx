      ...
      <aside id="separator-sidebar" class="xl:w-64 w-ful  transition-transform  fixed z-20 lg:static lg:z-0" aria-label="Sidebar">
        ...
        <div class="h-full px-3 pb-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          ...
          <ul class="space-y-2 font-medium">
            ...
            <Link
              onClick={handleSelectSubSection}
              to={'/dashbord/myProfile'}>
              <li>
                <a href="#Profile" class={`${currLocation === '/dashbord/myProfile' ? 'dark:bg-gray-700' : ''} flex items-center p-2 text-gray-900 rounded-lg dark:text-white  group`}>
                  <svg
                    class={`${currLocation === '/dashbord/myProfile' ? 'text-white' : ''}  flex-shrink-0 w-5 h-5 text-gray-400 transition duration-75`}
