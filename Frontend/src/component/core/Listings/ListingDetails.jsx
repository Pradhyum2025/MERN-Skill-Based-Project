  ...
  return (
    <div className="w-full bg-gray-50 py-5 px-4 sm:px-6 lg:px-8">
      <div className=" mx-auto">
        ...
        <button className='btn'><FaAngleLeft/>
          Back
        </button>
          ...
          <div class="grid items-start grid-cols-1 lg:grid-cols-2 gap-8 max-lg:gap-12 max-sm:gap-8">
            <div class="w-full lg:sticky top-0">
              <div class="flex flex-col gap-4">
                ...
                <div class="bg-white shadow p-2 hover:scale-105 overflow-x-hidden">
                ...
                <div class="bg-white p-2 w-full max-w-full overflow-auto">
                  <div class="flex justify-between flex-row gap-4 shrink-0">
                    {listing && listing.images.map(img => {
                      return <img src={img} alt="Product1"
            ...
            <div class="w-full">
              ...
              {/* Prices and discount */}
                <div class="flex items-center flex-wrap gap-5  mt-4">
                  ...
                  <h4 class="text-purple-800 text-2xl sm:text-3xl flex items-center gap-1 font-bold"><HiCurrencyRupee />{listing?.price - (listing?.price * (listing?.discount / 100))} </h4>
                ...
                <div>
                  <h4 class="text-base mt-4 text-gray-500 font-semibold">Net Wt: {listing?.productWeight}kg</h4>
                </div>
              </div>
              ...
              <div class='flex justify-between gap-4 mt-6'>
                ...
                <div class="text-center">
                  ...
                  <p class='text-gray-500 text-xs sm:text-sm mt-3'>Free Delivery On Orders Above <HiCurrencyRupee /> 200</p>
                </div>
              </div>
            </div>
          </div>
